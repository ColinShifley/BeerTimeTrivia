$(document).ready(function () {
	...
	var questions = [{
		question: 'How far back in history has beer been traced?',
	...
	var game = {
		...
		loadQuestion: function () {
			...
			$('#subwrapper').append('<div id="questionBox">');
			$('#questionBox').append('<h2>' + questions[game.currentQuestion].question + '</h2>');
			for (var i = 0; i < questions[game.currentQuestion].answers.length; i++) {
				$('#questionBox').append('<button class="answer-button" id="button-' + i + '" data-name="' + questions[game.currentQuestion].answers[i] + '">' + questions[game.currentQuestion].answers[i] + '</button>');
			}
		},

		statusBox: function () {
			$('#questionBox').append("<div id='qbox'><h4>Correct: " + game.correct + "</h4><h4>Incorrect: " + game.incorrect + "</h4><h4>Unanswered: " + game.unanswered + "</h4></'qbox'>");
			//$('#subwrapper').append("<qbox><h3>Incorrect: "+game.incorrect+"</h3></qbox>");
			//$('#subwrapper').append("<qbox><h3>Unanswered: "+game.unanswered+"</h3></qbox>")
		},
